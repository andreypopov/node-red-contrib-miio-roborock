        ...
        switch (model) {
            ...
            case "rockrobo.vacuum.c1":
                return {
                    ...
                    // 1-38%   = "Quiet / Leise"
                    38: { homekitTopLevel: 38, miLevel: 38, name: "Quiet" },
                    // 39-60%  = "Balanced / Standard"
                    60: { homekitTopLevel: 60, miLevel: 60, name: "Balanced" },
                    // 61-77%  = "Turbo / Stark"
                    77: { homekitTopLevel: 77, miLevel: 77, name: "Turbo" },
            ...
            case "roborock.vacuum.s5":
                return {
                    ...
                    105: { homekitTopLevel: 15, miLevel: 105, name: "Mop" },
                    // 16-38%  = "Quiet / Leise"
                    38: { homekitTopLevel: 38, miLevel: 38, name: "Quiet" },
                    // 39-60%  = "Balanced / Standard"
                    60: { homekitTopLevel: 60, miLevel: 60, name: "Balanced" },
            ...
            case "roborock.vacuum.m1s":
                return {
                    ...
                    0: {homekitTopLevel: 0, miLevel: 0, name: "Off"},
                    // 1-38%   = "Quiet / Leise"
                    101: {homekitTopLevel: 38, miLevel: 101, name: "Quiet"},
                    // 39-60%  = "Balanced / Standard"
                    102: {homekitTopLevel: 60, miLevel: 102, name: "Balanced"},
                    // 61-77%  = "Turbo / Stark"
                    103: {homekitTopLevel: 77, miLevel: 103, name: "Turbo"},
                    // 78-100% = "Full Speed / Max Speed / Max"
