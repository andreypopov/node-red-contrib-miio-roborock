...
class MiioRoborockVocabulary {
    ...
    static get commands() {
        return {
            app_start: {name:"Start vacuuming", link:"", args:false},
            app_stop: {name:"Stop vacuuming", link:"", args:false},
            app_spot: {name:"Start spot cleaning", link:"", args:false},
            app_pause: {name:"Pause cleaning", link:"", args:false},
            app_charge: {name:"Start charging", link:"", args:false},
            find_me: {name:"Send findme", link:"", args:false},
            ...
            get_status: {name:"Get Status information", link:"https://github.com/marcelrv/XiaomiRobotVacuumProtocol/blob/master/StatusMessage.md", args:true},
            ...
            set_custom_mode: {name:"Set the vacuum level", link:"https://github.com/marcelrv/XiaomiRobotVacuumProtocol/blob/master/FanPower.md", args:true},
            ...
            app_zoned_clean: {name:"Start zone vacuum", link:"https://github.com/marcelrv/XiaomiRobotVacuumProtocol/blob/master/app_zoned_clean.md", args:true},
